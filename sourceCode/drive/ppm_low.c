...
#define MAX_PPM 8
#define SP_OFFSET 514//525 //SP偏置值，查看void SetMotor(INT8U id,INT16S sp)，使当sp=0时，小车静止
...
{
		SetPpm(id,sp/2 + SP_OFFSET);
	//SetPpm(id,525+sp/2);	///robot_low的调整为525让SetMotor的参数为0时处于停止状态
}
